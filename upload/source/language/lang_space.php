...
$lang = array(
	...
	'friend_group_1' => 'Quen qua web',
	'friend_group_2' => 'Quen qua hoạt động',
	'friend_group_3' => 'Quen qua người bạn',
	'friend_group_4' => 'Họ hàng',
	'friend_group_5' => 'Đồng nghiệp',
	'friend_group_6' => 'Bạn cùng lớp',
	'friend_group_7' => 'Không biết',
	'friend_group' => 'Tuỳ chỉnh',
	'wall' => 'Tường',
	...
	'constellation_8' => 'Xữ nữ',
	'constellation_9' => 'Thiên bình',
	'constellation_10' => 'Bò cạp',
	...
	'block4' => 'Kiểu 4',
	'block5' => 'Kiểu 5',
	'blockdata' => array('personalinfo' => 'Thông tin cá nhân', 'profile' => 'Hình đại diện', 'doing' => 'Trạng thái', 'feed' => 'Feed',
				'blog' => 'Blog', 'stickblog' => 'Stick blog', 'album' => 'Album', 'friend' => 'Bạn bè',
				'visitor' => 'Khách ghé thăm gần đây', 'wall' => 'Bảng tin', 'share' => 'Chia sẻ',
				'thread' => 'Chủ đề', 'group'=>(isset($_G['setting']['navs'][3]['navname']) ? $_G['setting']['navs'][3]['navname'] : ''),'music'=>'Âm nhạc',
	...
	'visitor_list' => '<a href="home.php?mod=space&uid={uid}" target="_blank" class="avt"><em class="{class}"></em><em class="{self}" onclick="javascript:removeVisitor(event, {cuid});" title="Xóa dấu chân của khách truy cập"></em>{avatar}</a><p><a href="home.php?mod=space&uid={uid}" title="{username}">{username}</a></p>',
	...
	'poll_li' => '<div class="c z"><img alt="poll" src="'.STATICURL.'image/feed/poll.gif" alt="poll" class="t" /><h4 class="h"><a target="_blank" href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a></h4><div class="mtn xg1">Đăng lúc: {dateline}</div></div>',
	'music_no_content' => 'Không có gì trong hộp nhạc',
	'block_profile_diy' => 'Trang trí',
	'block_profile_wall' => 'Tường',
	'block_profile_avatar' => 'Hình đại diện',
	'block_profile_update' => 'Cập nhật',
	'block_profile_follow' => 'Xem trang',
	'block_profile_wall_to_me' => 'Tường nhà',
	...
	'pm_export_header' => 'Discuz! Bản ghi tin nhắn ngắn X (bản ghi tin nhắn này không hỗ trợ nhập lại)',
	...
	'sb_blog' => 'Blog {who}',
	'sb_album' => 'Album {who}',
	'sb_space' => 'Trang cá nhân {who}',
	'sb_feed' => 'Cập nhật {who}',
	'sb_doing' => 'Tâm trạng {who}',
	...
	'block_profile_edit' => '<span class="y xw0"><a href="home.php?mod=spacecp&ac=profile">Sửa</a></span>',
	'sb_follow' => '{who} theo dõi',
	...
	'viewthread_userinfo_digestposts' => 'Hay nhất',
	...
	'follow_view_my_follower' => 'Bài viết theo dõi',
	'follow_view_my_following' => 'Tôi đang theo dõi',
	'follow_view_do_follower' => 'Khán giả của tôi',
	'follow_view_do_following' => 'Theo mọi người',
	'follow_view_fulltext' => '... Xem chi tiết',
	'follow_retract' => 'Từ bỏ',
	'follow_click_play' => 'Nhấn để xem',
	'follow_cancle_follow' => 'Bỏ theo dõi',
	'follow_follow_ta' => 'Theo dõi',
