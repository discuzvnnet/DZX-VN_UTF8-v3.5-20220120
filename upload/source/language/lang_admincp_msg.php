...
$lang = array (
  ...
  'members_unarchive_succeed' => '符合条件的 {numunarchived} 个用户被成功移出存档表',
  ...
  'membersplit_split_must_be_closed' => '请在站点关闭的状态下进行用户分表操作',
  ...
  'smsgw_nonexistence' => '短信网关不存在',
  'smsgw_name_invalid' => '您没有填写短信网关名称',
  'smsgw_name_more' => '抱歉，您的短信网关名称超过 255 个字符',
  'smsgw_order_invalid' => '短信网关排序非法',
  'smsgw_sendrule_invalid' => '短信网关发送方法非法',
  'smsgw_succeed' => '短信网关配置成功更新',
  ...
  'members_ipban_closed' => '禁止 IP 功能已在 config_global.php 内被关闭',
  ...
  'membersplit_split_in_backstage' => '正在进行用户分表，请稍后重试...',
  'membersplit_split_check_table' => '正在进行数据表一致性检查...',
  'membersplit_split_succeed' => '用户分表完毕，已经没有可以继续移动到存档表的用户 ',
  'membersplit_split_doing' => '正在进行用户分表，已经移动到存档表 {num} 个用户... ',
  'membersplit_split_check_table_done' => '数据表结构一致性检查完毕，正在进行用户数据优化',
  'membersplit_split_checking_table' => '正在进行数据表一致性检查，第 {step} 步',
  'membersplit_split_check_table_fail' => '数据表数据结构整理失败，请手工处理将主表({tablename})和存档表({tablename}_archive)的数据结构调整按顺序调整一致。',
