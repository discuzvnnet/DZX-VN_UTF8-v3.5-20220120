...
(
	...
	'showcredit' => '{actor} tặng bạn {credit} điểm, để giúp bạn lên hạng ở <a href="misc.php?mod=ranklist&type=member" target="_blank"> bảng xếp hạng</a> thành viên',
	...
	'doing_reply' => '{actor} đã trả lời <a href="{url}" target="_blank">hồ sơ</a> của bạn',
	...
	'wall' => '{actor} để lại lời nhắn tại <a href="{url}" target="_blank">Tường</a>của bạn',
	...
	'click_article' => '{actor} đã gửi biểu cảm với <a href="{url}" target="_blank">tác phẩm </a>của bạn',
	'show_out' => '{actor} đã ghé thăm Blog của bạn làm tăng lượt truy cập và thứ hạng',
	'puse_article' => 'Chúc mừng bạn, chủ đề <a href="{url}" target="_blank">{subject}</a>của bạn đã được đề cử đến portal, <a href="{newurl}" target="_blank">nhấn để xem</a>',

	'group_member_join' => '{actor} tham gia nhóm <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a> của bạn cần được xem xét, vui lòng chuyển đến nhóm <a href="{url}" target="_blank">Nền tảng quản trị</a> để xem xét',
	'group_member_invite' => '{actor} đã mời bạn gia nhập nhóm -CLB <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a>,<a href="{url}" target="_blank">nhấn vào đây để gia nhập</a>',
	'group_member_check' => 'Bạn đã được chấp nhận vào nhóm CLB <a href="{url}" target="_blank">{groupname}</a>, hãy <a href="{url}" target="_blank">nhấn vào đây để xem</a>',
...
Nếu bạn tích lũy các cảnh báo {warningexpiration} trong {warninglimit} ngày liên tiếp, bạn sẽ tự động bị cấm phát biểu trong {warningexpiration} ngày.<br />
Tính đến thời điểm hiện tại, bạn đã được cảnh báo {authorwarnings} lần, hãy chú ý!<div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'reason_live_update' => 'Chủ đề <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> bởi {actor} được thiết lập live <div class="quote"><blockquote>{reason}</blockquote></div>',
	'reason_live_cancle' => 'Chủ đề <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> bởi {actor} hủy live <div class="quote"><blockquote>{reason}</blockquote></div>',

	'modthreads_delete' => 'Chủ đề {threadsubject} không được chấp thuận, đã bị xóa !',

	'modthreads_delete_reason' => 'Chủ đề {threadsubject} mà bạn viết không được đồng ý, đã bị xóa!<div class="quote"><blockquote>{reason}</blockquote></div>',
	'modthreads_validate' => 'Chủ đề <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{threadsubject}</a> đã được phê duyệt! &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">Xem &rsaquo;</a>',

	'modreplies_delete' => 'Trả lời của bạn đã không được thông qua, hiện đã bị xóa! <p class="summary">Nội dung:<span>{post}</span></p>',

	'modreplies_delete_reason' => 'Câu trả lời của bạn đã không được chấp thuận và hiện đã bị xóa! <p class="summary">Nội dung trả lời:<span>{post}</span></p><div class="quote"><blockquote>{reason}</blockquote></div>',

	'modreplies_validate' => 'Trả lời của bạn đã được thông qua và công bố ! &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">Xem &rsaquo;</a> <p class="summary">Nội dung:<span>{post}</span></p>',
...
<p class="summary">{actor} Nói:<span>{transfermessage}</span></p>',
...
<p class="summary">Số thứ tự:<span>{orderid}</span></p><p class="summary">Chi phí:<span>{price} VNĐ</span></p><p class="summary">Doanh thu:<span>{value}</span></p>',
	...
	'trade_buyer_confirm' => 'Bạn mua <a href="forum.php?mod=trade&orderid={orderid}" target="_blank">{subject}</a>,<a href="home.php?mod=space&uid={sellerid}" target="_blank">{seller}</a> đã được chuyển đi, đang chờ bạn xác nhận &nbsp; <a href="forum.php?mod=trade&orderid={orderid}" target="_blank" class="lit">Xem &rsaquo;</a>',
	...
	'reppost_noticeauthor' => '{actor} trả lời bài viết: <a href="forum.php?mod=redirect&goto=findpost&ptid={tid}&pid={pid}" target="_blank">{subject}</a> của bạn&nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">Xem</a>',
	...
	'task_reward_medal' => 'Chúc mừng hoàn thành nhiệm vụ: <a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>, phần thưởng <a href="home.php?mod=medal" target="_blank"> là huân chương {rewardtext}</a> trong {bonus} ngày',
	...
	'task_reward_group' => 'Chúc mừng hoàn thành nhiệm vụ: <a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>, phần thưởng ngày sử dụng trong nhóm {rewardtext} trong {bonus} ngày &nbsp; <a href="home.php?mod=spacecp&ac=usergroup" target="_blank" class="lit">Kiểm tra &rsaquo;</a>',
	...
	'grouplevel_update' => 'Xin chúc mừng, nhóm của bạn {groupname} đã được nâng cấp lên {newlevel}.',
	...
	'article_invite' => '{actor} mời bạn xem chủ đề <a href="{url}" target="_blank">{subject}</a> &nbsp; <a href="{url}" target="_blank" class="lit">Xem &rsaquo;</a>',
	...
	'member_change_usergroup' => 'Bạn đã được {user} đổi thành nhóm người dùng {groupname} khoảng thời gian: {day} (0: có nghĩa là vĩnh viễn), thông tin nhóm mở rộng là {extgroupinfo}, bạn sẽ được thông báo về những thay đổi có liên quan theo yêu cầu của nhà điều hành, lý do cho hoạt động: {reason}',
	'member_change_credits' => 'Bạn đã được điều chỉnh bởi {user}, loại tín dụng và giá trị điều chỉnh là {extcredits}, bạn sẽ được thông báo về những thay đổi theo yêu cầu của nhà điều hành. Lý do hành động: {reason}',

	'member_follow' => 'Thần tượng của bạn mới đăng {count} bài viết, bạn hãy xem <a href="home.php?mod=follow">tại đây</a>',
	'member_follow_add' => '{actor} đã hâm mộ bạn và đăng ký theo dõi hoạt động của bạn, xem <a href="home.php?mod=follow&do=follower">tại đây</a>',
	...
	'manage_verifythread' => 'Có bài viết mới đang chờ duyệt trong box quản lý. <a href="admin.php?action=moderate&operation=threads&dateline=all">Xem xét ngay</a>',
	...
	'manage_verifyrecycle' => 'Có bài viết mới được chuyển vào trong thùng rác. <a href="admin.php?action=recyclebin">Xử lý ngay</a>',
	'manage_verifyrecyclepost' => 'Có bài trả lời mới được chuyển vào trong thùng rác.. <a href="admin.php?action=recyclebinpost">Xử lý ngay</a>',
...
<p class="mbn"><a href="home.php?mod=magic" target="_blank">Đạo cụ giảm giá</a><span class="pipe">|</span><a href="home.php?mod=magic&action=mybox" target="_blank">Xem hộp vật phẩm của tôi</a></p>',
	...
	'collection_becommented' => 'Bộ sưu tập  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> có comment mới.',
	'collection_befollowed' => 'Bộ sưu tập <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> có người theo dõi mới.',
	...
	'thread_hidden' => 'Chủ đề của bạn <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>đã bị nhiều người báo cáo là spam &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">Xem &rsaquo;</a>',
